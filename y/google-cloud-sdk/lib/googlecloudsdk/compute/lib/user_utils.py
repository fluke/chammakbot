...
class UserResourceFetcher(object):
  ...
  def LookupUsers(self, users):
    ...
    requests = []
    for user in users:
      request = (self.computeaccounts.users,
                 'Get',
                 self.computeaccounts.MESSAGES_MODULE.
                 ComputeaccountsUsersGetRequest(
  ...
  def CreateUser(self, user, owner_email, description=None):
    ...
    user = self.computeaccounts.MESSAGES_MODULE.User(
        name=user,
    ...
    request = (
        self.computeaccounts.users, 'Insert',
        self.computeaccounts.MESSAGES_MODULE.ComputeaccountsUsersInsertRequest(
            project=self.project,
            user=user))
  ...
  def RemovePublicKey(self, user, fingerprint):
    ...
    request = (
        self.computeaccounts.users, 'RemovePublicKey',
        self.computeaccounts.MESSAGES_MODULE
        .ComputeaccountsUsersRemovePublicKeyRequest(
            project=self.project,
  ...
  def PublicKeyGenerateUploadRequest(
    ...
    public_key_message = self.computeaccounts.MESSAGES_MODULE.PublicKey(
        description=description,
        expirationTimestamp=expiration_time,
        key=public_key)

    request = (
        self.computeaccounts.users, 'AddPublicKey',
        self.computeaccounts.MESSAGES_MODULE
        .ComputeaccountsUsersAddPublicKeyRequest(
            project=self.project,
