...
_COMPUTEACCOUNTS_RO = 'https://www.googleapis.com/auth/computeaccounts.readonly'
_LOGGING_WRITE = 'https://www.googleapis.com/auth/logging.write'
_MONITORING_RW = 'https://www.googleapis.com/auth/monitoring'

DEFAULT_SCOPES = [_STORAGE_RO, _COMPUTEACCOUNTS_RO, _LOGGING_WRITE]
...
SCOPES = {
    ...
    'computeaccounts-ro': _COMPUTEACCOUNTS_RO,
