...
class CreateBetaGA(base_classes.BaseAsyncCreator, image_utils.ImageExpander,
  ...
  def CreateRequests(self, args):
    ...
    image_key_or_none, snapshot_key_or_none = (
        csek_utils.MaybeLookupKeysByUri(
    ...
    for disk_ref in disk_refs:
      ...
      if csek_keys:
        ...
        kwargs = {'diskEncryptionKey': disk_key_or_none,
                  'sourceImageEncryptionKey': image_key_or_none,
                  'sourceSnapshotEncryptionKey': snapshot_key_or_none}
      else:
        kwargs = {}
...
class CreateAlpha(CreateBetaGA):
  """Create Google Compute Engine persistent disks."""
...
CreateBetaGA.detailed_help = DETAILED_HELP
