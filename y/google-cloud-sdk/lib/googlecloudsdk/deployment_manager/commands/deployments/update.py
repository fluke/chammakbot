...
class Update(base.Command):
  ...
  detailed_help = {
      ...
      'EXAMPLES': """\
          ...
          To specify different create, update, or delete policies, include any subset of the following flags;
            ...
            $ {command} my-deployment --config new_config.yaml --create-policy ACQUIRE --update-policy UPDATE --delete-policy ABANDON
  ...
  def Args(parser):
    ...
    parser.add_argument(
        ...
        choices=(v2beta2_messages.DeploymentmanagerDeploymentsUpdateRequest
                 .CreatePolicyValueValuesEnum.to_dict().keys()))

    parser.add_argument(
        '--update-policy',
        help='Update policy for resources that have changed in the update. '
        'Can be PATCH (default) or UPDATE.',
        dest='update_policy',
        default='PATCH',
        choices=(v2beta2_messages.DeploymentmanagerDeploymentsUpdateRequest
                 .UpdatePolicyValueValuesEnum.to_dict().keys()))
  ...
  def Run(self, args):
    ...
    if args.config:
      deployment.target = dm_v2_util.BuildTargetConfig(messages, args.config)
    ...
    try:
      operation = client.deployments.Update(
          messages.DeploymentmanagerDeploymentsUpdateRequest(
              ...
              updatePolicy=(messages.DeploymentmanagerDeploymentsUpdateRequest
