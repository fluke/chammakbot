...
class ApheleiaProjectsRegionsFunctionsCreateRequest(_messages.Message):
  ...
  Fields:
    hostedFunction: A HostedFunction resource to be passed as the request
      body.
    location: The project and zone in which the function should be created,
...
class HostedFunction(_messages.Message):
  ...
  class StatusValueValuesEnum(_messages.Enum):
    ...
    Values:
      NOT_SPECIFIED: Status not specified
  ...
  triggers = _messages.MessageField('FunctionTrigger', 4, repeated=True)
