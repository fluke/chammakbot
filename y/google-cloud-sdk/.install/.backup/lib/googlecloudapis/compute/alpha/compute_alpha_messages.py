...
class BackendService(_messages.Message):
  ...
  Fields:
    ...
    description: An optional textual description of the resource. Provided by
      the client when the resource is created.
    enableCaching: If true, responses from this BackendService can be cached,
      if their headers permit it.
  ...
  creationTimestamp = _messages.StringField(2)
  description = _messages.StringField(3)
  enableCaching = _messages.BooleanField(4)
...
class SslCertificate(_messages.Message):
  ...
  Fields:
    ...
    name: Name of the resource; provided by the client when the resource is
      ...
      be a dash, lowercase letter, or digit, except the last character, which
      cannot be a dash.
    privateKey: A write-only private key. PEM format. Only insert RPCs will
      include this field.
    selfLink: [Output only] Server defined URL for the resource.
  """
